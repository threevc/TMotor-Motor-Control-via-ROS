...
class TMotorControl:
    ...
    def pid_control(self):
        ...
        if ((self.velocity < 0.005) and (self.velocity > -0.005)) and ((self.position_error < 0.005) and (self.position_error > -0.005)):
            self.ki = 1000
        ...
        print('Pos | Vel | P_Des | V_Des | Integ | Tor = ', round(self.position,4), round(self.velocity,4), self.position_desired, self.velocity_desired,self.integ, self.torque)
    ...
    def pd_control(self):
        ...
        #self.listener()
        # print('The position in the variable is                                     ', self.position)
        self.position_error = self.position_desired - self.position
        self.velocity_error = self.velocity_desired - self.velocity
        ...
        print('Pos | Vel | P_Des | V_Des | Tor = ', round(self.position,2), round(self.velocity,2), self.position_desired, self.velocity_desired,self.torque)
